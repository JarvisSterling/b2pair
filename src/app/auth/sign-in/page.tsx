    ...
    <main className="flex min-h-screen items-center justify-center px-6 py-12 bg-gradient-hero">
      <div className="w-full max-w-sm animate-scale-in">
        <div className="mb-10 text-center">
          ...
          <h1 className="text-h1 tracking-tight">Welcome back</h1>
        ...
        <Card className="shadow-md border-border">
          <CardContent className="pt-6">
            <form onSubmit={handleSignIn} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/auth/forgot-password" className="text-caption text-primary hover:underline">Forgot?</Link>
                </div>
                <div className="relative">
                  <Lock className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
                  <Input id="password" type="password" placeholder="Enter your password" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10 h-11 rounded-xl" required />
                </div>
              </div>
            ...
            <div className="space-y-3">
              <Button variant="outline" className="w-full h-11 rounded-xl" onClick={handleGoogleSignIn}>
              ...
              <Button variant="ghost" className="w-full text-muted-foreground" onClick={handleMagicLink}>
