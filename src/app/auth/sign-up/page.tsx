    ...
    <main className="relative flex min-h-screen items-center justify-center px-6 py-12">
      ...
      <div className="relative w-full max-w-sm animate-scale-in">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-h1 font-bold tracking-tight">Create your account</h1>
            ...
            <form onSubmit={handleSignUp} className="space-y-4">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="firstName" type="text" placeholder="Jane" value={firstName} onChange={(e) => setFirstName(e.target.value)} className="pl-10" required />
                  </div>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" type="password" placeholder="At least 8 characters" value={password} onChange={(e) => setPassword(e.target.value)} className="pl-10" minLength={8} required />
                </div>
              </div>
